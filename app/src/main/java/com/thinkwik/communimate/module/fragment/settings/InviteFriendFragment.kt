...
import com.thinkwik.communimate.databinding.FragmentInviteFriendBinding
import com.thinkwik.communimate.module.adapter.ContactsAdapter
...
class InviteFriendFragment :
    BaseFragment<FragmentInviteFriendBinding>(R.layout.fragment_invite_friend) {
    ...
    private fun searchList(text: String) {
        ...
        Log.d(
            "searchList",
            "searchList:${combinedList.size} text $text ${combinedList.joinToString()}"
        )
