package com.thinkwik.whatsappclone.widget.story;
...
public class StoryPlayerProgressView extends View {
    ...
    public static final int GAP_BETWEEN_PROGRESS_BARS = 1;
    public static final int SINGLE_STORY_DISPLAY_TIME = 3000;
    ...
    private void startAnimating(final int index) {
        ...
        isCancelled = false;
        Log.d("story-progress", "=============================================================");
        Log.d("story-progress", "startAnimating: currentProgressIndex : " + currentProgressIndex);
        ...
        progressAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                Log.d("story-progress", "onAnimationStart: ");
            }

            @Override
            public void onAnimationEnd(Animator animator) {
                Log.d("story-progress", "onAnimationEnd: ");
                if (!isCancelled) {
                    currentProgressIndex++;
                    startAnimating(currentProgressIndex);
                }
            }

            @Override
            public void onAnimationCancel(Animator animator) {
                Log.d("story-progress", "onAnimationCancel: ");
                isCancelled = true;
            }

            @Override
            public void onAnimationRepeat(Animator animator) {
                Log.d("story-progress", "onAnimationRepeat: ");
            }
        });
    ...
    public void next() {
        progressAnimator.cancel();
        progressBarRightEdge[currentProgressIndex] = (currentProgressIndex + 1) * mGapBetweenProgressBars + currentProgressIndex * singleProgressBarWidth + singleProgressBarWidth;
        invalidate();
        currentProgressIndex++;
        startAnimating(currentProgressIndex);
    }
    ...
    public void previous() {
        progressAnimator.cancel();
        progressBarRightEdge[currentProgressIndex] = (currentProgressIndex + 1) * mGapBetweenProgressBars + currentProgressIndex * singleProgressBarWidth + 0;
        invalidate();
